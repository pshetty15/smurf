...
"""
SNARF MCP Server
Model Context Protocol server for SNARF RAG system
"""
...
class SNARFMCPServer:
    """MCP Server implementation for SNARF."""
    
    def __init__(self):
        self.server = Server("snarf-mcp")
        self.db = None
        self.router = None
    ...
    async def run(self):
        ...
        async with self.server:
            ...
            logger.info("🎮 SNARF MCP server is running...")
